...
<body>
	...
	<section class="box-section">
		<div style="max-height: 450px; overflow: auto; width: 25%" class="shadowed-form">
			<h1 style="color: #6dae25" class="display-5">Book Now</h1>
			<hr>
			<jsp:include page="./components/booknow-component.jsp" />
		</div>
		<div style="max-height: 450px; overflow: auto; width: 35%; height: fit-content;" class="shadowed-form">
			<h1 style="color: #386b00;" class="display-5">Booking History</h1>
			<hr>
			<jsp:include page="./components/booking-history-component.jsp" />
		</div>
		<div style="max-height: 450px; overflow: auto; width: 30%; height: fit-content;" class="shadowed-form">
