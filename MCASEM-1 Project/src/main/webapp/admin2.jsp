...
<div class="main">
    ...
    <div class="content">
	   <% 
	   ResultSet rs=Data.getPendingOrderDetails();
	   while(rs.next()){
	   %>
       <div class="order">
            ...
            <div class="low">
               <a href="<%="updateOrder?id="+rs.getString(1)+"&status=CANCELLED" %>" class="operation">Cancel Order</a>
               <a href="<%="updateOrder?id="+rs.getString(1)+"&status=ON THE WAY" %>" class="operation">On The Way</a>
               <a href="<%="updateOrder?id="+rs.getString(1)+"&status=DELIVERED" %>" class="operation">Delivered</a>
            </div>
       </div>
       <%
	   }
