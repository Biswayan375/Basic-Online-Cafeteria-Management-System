...
<div class="main">
    ...
    <div class="content">
        <table class="booking">
            ...
            <%
            ResultSet rs=Data.getPendingBookings();
            while(rs.next()){
            %>
            <tr>
                ...
                <td><a href="<%="updateBooking?bid="+rs.getString(6)+"&tid="+rs.getString(7)+"&op=s"%>">Settled</a><a href="<%="updateBooking?bid="+rs.getString(6)+"&tid="+rs.getString(7)+"&op=c"%>">Cancel</a></td>
            </tr>
            <%
            }
            %>
